...
public class FlowProp extends Sun implements MouseMotionListener, MouseListener {
	private int flowSpeed = 1;// 下落速度
	private final static ImageIcon sun = new ImageIcon(Sun.class.getResource("/images/gif/prop1.gif"));
	private int randomNumber;
	private long sunBeginTime = 0;

	public FlowProp(int x, int y, JFrame jFrame) {
		super();// 好像没有用
		super.type = 1;
		this.x = x;
		this.y = y;
